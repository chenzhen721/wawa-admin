...
import com.wawa.api.notify.GameService
import com.wawa.api.notify.MessageSend
...
import static com.wawa.common.doc.MongoKey.NATURAL_DESC
...
//                    "\"x-gmkerl-type\":\"\","+
        ...
        def policy = Base64.encodeBase64String(json.getBytes('UTF-8'))
        return [code: 1, data: [
