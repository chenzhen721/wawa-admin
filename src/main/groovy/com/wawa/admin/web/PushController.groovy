...
import com.wawa.common.util.StrUtils
import com.wawa.model.IMType
import com.wawa.model.SysMsgType
import com.wawa.model.UmengEventType
...
//            }
        ...
        for (int i = 0; i < page + 1; i++) {
            ...
            if (len > 0) {
                ...
                table().find($$(_id: ['$in': subArray]), $$(cid: 1)).toArray().each { DBObject obj ->
